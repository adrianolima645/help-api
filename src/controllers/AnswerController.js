...
var yup = require("yup");
var AnswerModel_1 = require("../models/AnswerModel");
var AnswerController = /** @class */ (function () {
    function AnswerController() {
    }
    AnswerController.prototype.createAnswer = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, userId, questionId, answer, dateOfAnswer, schema, error_1, answerObj;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, userId = _a.userId, questionId = _a.questionId, answer = _a.answer, dateOfAnswer = _a.dateOfAnswer;
                    ...
                    case 4:
                        answerObj = new AnswerModel_1.Answer({
                            userId: userId,
                            questionId: questionId,
                            answer: answer,
                            dateOfAnswer: dateOfAnswer
                        });
                        return [4 /*yield*/, answerObj.save()];
                    case 5:
                        _b.sent();
                        return [2 /*return*/, response.status(200).json(answerObj)];
                }
            });
        });
    };
    AnswerController.prototype.findByUserId = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, schema, error_2, query, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        query = { userId: userId };
                        return [4 /*yield*/, AnswerModel_1.Answer.find(query)];
                    case 5:
                        result = _a.sent();
                        if (!result) {
